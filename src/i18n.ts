...
const ZH_T = {
  ...
  perfLat:    "延迟:",
  perfAvg:    "中位 {v}",
  perfFilterOn: "性能已按当前模型过滤",
  perfFilterOff: "性能统计范围为全会话",
  tokS:       "tok/s",
  balTotal:   "总余额:",
  ...
  barTTFT:    "首字",
  barTool:    "工具",
  barFirstToken: "首 Token",
  styleDefault: "默认",
  styleDsh: "DSH",
  styleMin: "极简",
  liveStyleTitle: "实时行样式",
  barStyleTitle: "提示栏样式",
  barItemsTitle: "底部栏项目",
  liveStyleSet: "实时行样式：{s}",
  barStyleSet: "提示栏样式：{s}",
  // ── /cache-section 面板 ──
  secToggle:  "切换区块",
  secBalance: "余额",
...
const EN_T: Translation = {
  ...
  perfLat:    "Latency:",
  perfAvg:    "med {v}",
  perfFilterOn: "Performance stats filtered to current model",
  perfFilterOff: "Performance stats now cover the whole session",
  tokS:       "tok/s",
  balTotal:   "Total:",
  ...
  styleDsh: "DSH",
  styleMin: "Minimal",
  liveStyleTitle: "Live Line Style",
  barStyleTitle: "Status Bar Style",
  barItemsTitle: "Status Bar Items",
  liveStyleSet: "Live line style: {s}",
  barStyleSet: "Status bar style: {s}",
  // ── /cache-section panel ──
...
const JA_T: Translation = {
  ...
  perfLat:    "遅延:",
  perfAvg:    "中央値 {v}",
  perfFilterOn: "性能を現在のモデルに絞り込みました",
  perfFilterOff: "性能統計はセッション全体に戻しました",
  tokS:       "tok/s",
  balTotal:   "総残高:",
  ...
  styleDsh: "DSH",
  styleMin: "ミニマル",
  liveStyleTitle: "リアルタイム行スタイル",
  barStyleTitle: "ステータスバー スタイル",
  barItemsTitle: "ステータスバー項目",
  liveStyleSet: "リアルタイム行スタイル: {s}",
  barStyleSet: "ステータスバー スタイル: {s}",
  // ── /cache-section パネル ──
  secToggle:  "セクション切替",
  secBalance: "残高",
  secBottom:  "下部ステータスバー",
...
const KO_T: Translation = {
  ...
  perfLat:    "지연:",
  perfAvg:    "중앙값 {v}",
  perfFilterOn: "성능이 현재 모델로 필터링되었습니다",
  perfFilterOff: "성능 통계가 전체 세션으로 전환되었습니다",
  tokS:       "tok/s",
  balTotal:   "총 잔액:",
  ...
  styleDsh: "DSH",
  styleMin: "미니멀",
  liveStyleTitle: "실시간 행 스타일",
  barStyleTitle: "상태 표시줄 스타일",
  barItemsTitle: "상태 표시줄 항목",
  liveStyleSet: "실시간 행 스타일: {s}",
  barStyleSet: "상태 표시줄 스타일: {s}",
  // ── /cache-section 패널 ──
  secToggle:  "섹션 전환",
  secBalance: "잔액",
  secBottom:  "하단 상태바",

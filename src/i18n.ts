...
const ZH_T = {
  ...
  tpsStyleTitle: "实时 TPS 样式",
  tpsStyleDefault: "default",
  tpsStyleDsh: "dsh",
  tpsStyleSet: "实时 TPS 样式：{s}",
  // ── /cache-section 面板 ──
  secToggle:  "切换区块",
  secBalance: "余额",
  secBottom:  "底部状态栏",
...
const EN_T: Translation = {
  ...
  barTool:    "Tool",
  barFirstToken: "TTFT",
  tpsStyleTitle: "Real-time TPS Style",
  tpsStyleDefault: "default",
  tpsStyleDsh: "dsh",
  tpsStyleSet: "Real-time TPS style: {s}",
  // ── /cache-section panel ──
...
const JA_T: Translation = {
  ...
  barTool:    "ツール",
  barFirstToken: "TTFT",
  tpsStyleTitle: "リアルタイム TPS スタイル",
  tpsStyleDefault: "default",
  tpsStyleDsh: "dsh",
  tpsStyleSet: "リアルタイム TPS スタイル: {s}",
  // ── /cache-section パネル ──
  secToggle:  "セクション切替",
  secBalance: "残高",
  secBottom:  "下部ステータスバー",
...
const KO_T: Translation = {
  ...
  barTool:    "도구",
  barFirstToken: "TTFT",
  tpsStyleTitle: "실시간 TPS 스타일",
  tpsStyleDefault: "default",
  tpsStyleDsh: "dsh",
  tpsStyleSet: "실시간 TPS 스타일: {s}",
  // ── /cache-section 패널 ──
  secToggle:  "섹션 전환",
  secBalance: "잔액",
  secBottom:  "하단 상태바",

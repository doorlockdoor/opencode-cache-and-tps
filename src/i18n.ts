...
const EN_T: Translation = {
  ...
  styleDsh: "DSH",
  styleMin: "Minimal",
  styleTitle: "Display Style",
  styleSet: "Display style: {s}",
  barItemsTitle: "Display Items",
  tpsOutput: "Output Speed",
  tpsPerceived: "Perceived Speed",
  tpsModeTitle: "Speed Calculation",
  tpsModeSet: "Speed calc: {s}",
  // ── /cache-section panel ──
